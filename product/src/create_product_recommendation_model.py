...
#
# columns = ["average_temperature", "highest_temperature", "lowest_temperature", "daily_temperature_range",
#            "average_humidity", "precipitation"]
#
#
...
#
#         # 훈련/테스트 데이터 분리
#         df_x_train, df_x_test, df_y_train, df_y_test = train_test_split(df_x_data, df_y_data, test_size=0.3,
#                                                                         random_state=20221004)
#
#         # 데이터 통계량 요약
